...
- [ResearchNet](/projects/researchnet) — speculative automation layer that extends the data model LabKit is building
- [DIAL Recruitment & Onboarding Redesign](/projects/dial-recruitment) — parallel DIAL project; LabKit needed to exist first to give DIAL the infrastructure to take on more interns
- [HCI Internship for HS Students](/projects/hci-internship) — downstream: the internship program only becomes feasible once LabKit gives DIAL the capacity to handle more people
- [Fieldkit OSS](/projects/fieldkit) — parallel philosophy; LabKit is to research labs what Fieldkit is to student orgs: opinionated, reproducible infrastructure
