...
- [LabKit](/projects/labkit) — DIAL's research platform; solving capacity constraints is the other half of the recruitment problem
- [Nonbinary NLP Research Proposal (MISGENDERED++)](/projects/misgendered-nlp) — my first project at DIAL, which gave me the context to redesign recruitment
- [HCI Internship for HS Students](/projects/hci-internship) — the downstream program that depends on this redesign being in place first
