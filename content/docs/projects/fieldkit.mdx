...
- [Literature Workflow Redesign with Ghost CMS](/projects/ghost-cms-workflow) — the Ghost module, validated at DAY's literature department
- [GitLab-Inspired Handbook](/projects/gitlab-handbook) — the docs-as-code module, running live at DAY
- [DAY Design System & Marketing Funnel](/projects/day-design-system) — the design system module, also live at DAY
- [LabKit](/projects/labkit) — same philosophy applied to research labs; both are opinionated, reproducible infra stacks for specific org archetypes
