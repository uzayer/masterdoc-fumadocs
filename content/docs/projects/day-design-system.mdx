...
- [Fieldkit OSS](/projects/fieldkit) — this design system is one of Fieldkit's core modules, being validated at DAY before extraction into a template
- [Literature Workflow Redesign with Ghost CMS](/projects/ghost-cms-workflow) — the content system that surfaces through this design language
- [GitLab-Inspired Handbook](/projects/gitlab-handbook) — the knowledge infrastructure this design system governs
